		...
		<div class="flex w-full flex-row items-center justify-between">
			...
			<div class="inline-flex rounded-md shadow-sm" role="group">
				<button
					...
					class:active={size === 4}
					disabled={true}
					class="rounded-l-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-400 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
				>
					4x4
				</button>
				<button
				...
				<button
					...
					disabled={true}
					class="rounded-r-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-400 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
				>
					16x16
				</button>
			</div>
